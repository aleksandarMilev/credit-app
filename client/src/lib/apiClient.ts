...
export const apiFetch = async <T>(
  ...
  // 204 No Content (e.g. DELETE /applications/{id}/) has no body — calling
  // .json() on it throws, which would otherwise get misreported as a
  // networkError() below even though the request succeeded.

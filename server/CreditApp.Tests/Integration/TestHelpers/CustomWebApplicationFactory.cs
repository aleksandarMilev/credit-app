...
public class CustomWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public CustomWebApplicationFactory()
    {
        ...
        Environment.SetEnvironmentVariable("ApplicationRetentionSettings__SoftDeleteAfterDays", "1");
        Environment.SetEnvironmentVariable("ApplicationRetentionSettings__HardDeleteGracePeriodDays", "1");
    }
    ...
    public async Task InitializeAsync()
    {
        ...
        await InterestRateSeeder.SeedIfMissing(scope.ServiceProvider);
    }

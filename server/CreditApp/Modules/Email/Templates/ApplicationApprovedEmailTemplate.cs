...
public static class ApplicationApprovedEmailTemplate
{
                            ...
                            <table role="presentation" width="100%" style="max-width:480px; background-color:#ffffff; border-radius:8px; overflow:hidden;">
                                ...
                                <tr>
                                    <td style="padding:32px;">
                                        <h1 style="margin:0 0 16px; font-size:22px; color:#111827;">Вашата заявка е одобрена</h1>
                                        <p style="margin:0 0 16px; font-size:15px; line-height:1.6; color:#374151;">
                                            Уважаеми/а {safeName},
                                        </p>
                                        <p style="margin:0 0 24px; font-size:15px; line-height:1.6; color:#374151;">
                                            Имаме удоволствието да Ви уведомим, че след преглед Вашата кредитна заявка
                                            беше одобрена. Наш служител ще се свърже с Вас допълнително относно
                                            следващите стъпки.
                                        </p>
                                    </td>
                                </tr>
